...
# -*- encoding: utf-8 -*-
"""
@File:  news_recommend_task4.py.py    
@Modify Time   @Author   @Version   @Desciption
------------   -------   --------   -----------
2022/1/18 7:14 下午   ghj      1.0         排序
"""
...
#
# 构造监督数据集的思路， 根据召回结果， 我们会得到一个
# {user_id: [可能点击的文章列表]}
# 形式的字典。 那么我们就可以对于每个用户， 每篇可能点击的文章构造一个监督测试集， 比如对于用户user1， 假设得到的他的召回列表
...
# cbow：已知周围词预测中心词。 image - 20201106225233086
